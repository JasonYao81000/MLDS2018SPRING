...
def parse_args():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./hw3_1/checkpoint',
                        help='Directory name to save the checkpoints')
    parser.add_argument('--result_dir', type=str, default='./hw3_1/results',
                        help='Directory name to save the generated images')
    parser.add_argument('--log_dir', type=str, default='./hw3_1/logs',
