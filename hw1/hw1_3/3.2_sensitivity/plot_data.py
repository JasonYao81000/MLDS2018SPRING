...
sens = np.load('./MNIST_stat/sensitivity_list.npy')
train_loss = np.load('./MNIST_stat/train_loss_list.npy')
train_acc = np.load('./MNIST_stat/train_acc_list.npy')
test_loss = np.load('./MNIST_stat/test_loss_list.npy')
test_acc = np.load('./MNIST_stat/test_acc_list.npy')
print(sens)
