...
if __name__ == "__main__":
    ...
    np.save('train_acc_history_CNN_model2.npy', fitHistory.history['acc'])
    np.save('train_loss_history_CNN_model2.npy', fitHistory.history['loss'])
    np.save('test_acc_history_CNN_model2.npy', fitHistory.history['val_acc'])
    np.save('test_loss_history_CNN_model2.npy', fitHistory.history['val_loss'])
