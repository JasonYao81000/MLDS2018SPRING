...
if __name__ == "__main__":
    ...
    model.save('CNN_model0.h5')

    # Save history of acc to npy file.
    np.save('train_acc_history_CNN_model0.npy', fitHistory.history['acc'])
    np.save('train_loss_history_CNN_model0.npy', fitHistory.history['loss'])
    np.save('test_acc_history_CNN_model0.npy', fitHistory.history['val_acc'])
    np.save('test_loss_history_CNN_model0.npy', fitHistory.history['val_loss'])
