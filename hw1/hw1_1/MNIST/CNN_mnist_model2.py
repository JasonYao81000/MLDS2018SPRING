...
if __name__ == "__main__":
    ...
    model.add(Conv2D(12, (3, 3), kernel_initializer='lecun_normal', padding='SAME', bias_initializer='zeros'))
    ...
    np.save('train_acc_history_CNN_mnist_model2.npy', fitHistory.history['acc'])
    np.save('train_loss_history_CNN_mnist_model2.npy', fitHistory.history['loss'])
