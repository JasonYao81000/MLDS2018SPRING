...
if __name__ == "__main__":
    ...
    model.add(Conv2D(17, kernel_size=(3, 3),
                 activation='selu',
    ...
    model.save('CNN_mnist_model0.h5')

    # Save history of acc to npy file.
    np.save('train_acc_history_CNN_mnist_model0.npy', fitHistory.history['acc'])
    np.save('train_loss_history_CNN_mnist_model0.npy', fitHistory.history['loss'])
